...
This communication is typically done through [host-only networking](/v2/docs/host_only_networking.html). There is an entire page dedicated to the topic, but a relatively simple
...
the [host-only networking](/v2/docs/host_only_networking.html) page.
